...
var q=Object.defineProperty;var ne=Object.getOwnPropertyDescriptor;var se=Object.getOwnPropertyNames;var re=Object.prototype.hasOwnProperty;var oe=(o,t)=>{for(var e in t)q(o,e,{get:t[e],enumerable:!0})},ie=(o,t,e,a)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of se(t))!re.call(o,n)&&n!==e&&q(o,n,{get:()=>t[n],enumerable:!(a=ne(t,n))||a.enumerable});return o};var le=o=>ie(q({},"__esModule",{value:!0}),o);var ge={};oe(ge,{default:()=>L});module.exports=le(ge);var l=require("obsidian"),E="home-base-dashboard",ce={openOnStartup:!0,todoInboxPath:"Home Base/Todo Inbox.md",todoScanFolders:"Home Base",workoutPlanPath:"Home Base/Workout Plan.md",workoutLogPath:"Home Base/Workout Log.md",showSchedulePlaceholder:!0,calendarEnabled:!1,calendarServerUrl:"https://caldav.icloud.com",calendarUsername:"",calendarPassword:"",calendarUrl:"",calendarName:""},K=`# Todo Inbox
...
`,B="urn:ietf:params:xml:ns:caldav",N="DAV:";function I(o){let t=o.trim();return t?t.endsWith("/")?t:`${t}/`:""}function S(o,t){return new URL(t,I(o)).toString()}function de(o){return`${encodeURIComponent(o)}.ics`}function X(o){let t=o.replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`),e=[];for(let a of t)/^[ \t]/.test(a)&&e.length?e[e.length-1]+=a.slice(1):a.trim()&&e.push(a);return e}function Z(o){let t=o.indexOf(":");if(t===-1)return null;let e=o.slice(0,t),[a,...n]=e.split(";");return{name:a.toUpperCase(),params:n.join(";"),value:o.slice(t+1)}}function W(o){return o.replace(/\\n/gi,`
...
`)}\r
`}function he(o,t,e,a){var g,x,C,D,k,V,v,b;let n=X(o),s=n.findIndex(y=>y.toUpperCase()==="BEGIN:VEVENT"),r=n.findIndex((y,A)=>A>s&&y.toUpperCase()==="END:VEVENT");if(s===-1||r===-1)return null;let i=n.slice(s+1,r).map(Z).filter(y=>!!y),c=y=>i.find(A=>A.name===y),d=((g=c("UID"))==null?void 0:g.value)||((x=t.split("/").pop())==null?void 0:x.replace(/\.ics$/i,""))||crypto.randomUUID(),p=c("DTSTART");if(!p)return null;let u=G(p.value,p.params),h=c("DTEND"),m=h?G(h.value,h.params):{date:u.allDay?ee(u.date,1):Q(u.date,60),allDay:u.allDay};return{uid:d,href:t,etag:e,title:W((D=(C=c("SUMMARY"))==null?void 0:C.value)!=null?D:""),start:u.date,end:m.date,allDay:u.allDay,location:W((V=(k=c("LOCATION"))==null?void 0:k.value)!=null?V:""),notes:W((b=(v=c("DESCRIPTION"))==null?void 0:v.value)!=null?b:""),rawIcs:o,calendarName:a}}function f(o,t){let e=o instanceof Document?o.documentElement:o,a=Array.from(e.getElementsByTagName("*"));return e.localName===t&&a.unshift(e),a.filter(n=>n.localName===t)}function T(o,t){var e,a,n;return(n=(a=(e=f(o,t)[0])==null?void 0:e.textContent)==null?void 0:a.trim())!=null?n:""}function _(o,t){let e=f(o,t)[0];return e?T(e,"href"):""}function P(o){return new DOMParser().parseFromString(o,"application/xml")}var me=`
.home-base-view {
  min-height: 100%;
  padding: 32px;
...
</c:calendar-query>`,s=await this.caldavRequest(a.href,"REPORT",n,{Depth:"1"}),r=P(s.text);return{events:f(r,"response").map(c=>{let d=S(a.href,T(c,"href")),p=T(c,"getetag"),u=T(c,"calendar-data");return u?he(u,d,p,a.displayName):null}).filter(c=>!!c).filter(c=>c.end>=t&&c.start<e).sort((c,d)=>c.start.getTime()-d.start.getTime()),error:"",setupRequired:!1}}catch(a){return{events:[],error:this.readableCalendarError(a),setupRequired:!1}}}async saveCalendarEvent(t){let e=await this.getDefaultCalendar();if(!e){new l.Notice("Set up a default CalDAV calendar first.");return}let a=t.uid||crypto.randomUUID(),n=t.href||S(e.href,de(a)),s=t.rawIcs?pe(t.rawIcs,t,a):ae(t,a),r={"Content-Type":"text/calendar; charset=utf-8"};t.etag?r["If-Match"]=t.etag:r["If-None-Match"]="*";try{await this.caldavRequest(n,"PUT",s,r),new l.Notice("Calendar event saved.")}catch(i){throw new l.Notice(this.readableCalendarError(i)),i}}async deleteCalendarEvent(t){try{await this.caldavRequest(t.href,"DELETE","",t.etag?{"If-Match":t.etag}:{}),new l.Notice("Calendar event deleted.")}catch(e){throw new l.Notice(this.readableCalendarError(e)),e}}async testCalendarConnection(){if(!this.hasCalendarCredentials())throw new Error("Fill in the CalDAV server URL, Apple ID email, and app-specific password first.");let t=await this.getDefaultCalendar(!0,!0);if(!t)throw new Error("No event calendar was found for this CalDAV account.");return t}hasCalendarCredentials(){return!!(this.settings.calendarServerUrl.trim()&&this.settings.calendarUsername.trim()&&this.settings.calendarPassword.trim())}hasCalendarConfig(){return!!(this.settings.calendarEnabled&&this.hasCalendarCredentials())}async getDefaultCalendar(t=!1,e=!1){var r,i;if(e?!this.hasCalendarCredentials():!this.hasCalendarConfig())return null;if(this.settings.calendarUrl.trim()&&!t)return{href:I(this.settings.calendarUrl),displayName:this.settings.calendarName||"Calendar",writable:!0};let a=await this.discoverCalendars(),n=a.filter(c=>c.writable),s=(i=(r=a.find(c=>c.href===I(this.settings.calendarUrl)))!=null?r:n[0])!=null?i:a[0];return s?(this.settings.calendarUrl=s.href,this.settings.calendarName=s.displayName,await this.saveSettings(),s):null}async discoverCalendars(){let t=I(this.settings.calendarServerUrl),e=await this.caldavRequest(t,"PROPFIND",`<?xml version="1.0" encoding="utf-8" ?>
...
<d:propfind xmlns:d="${N}" xmlns:c="${B}">
  <d:prop>
    <c:calendar-home-set />
  </d:prop>
